...
filename1 = "failure_radius.log"
filename2 = "failure_apache.log"
debug = False
...
while loop :
	...
	# Write 1 MDN=5556374832
	radstartline = datetime.datetime.utcnow().strftime('%b %d %H:%M:%S') + ":000" + " " + radHost + " " + "radiusd[" + radPID + "]:" + "[ID 959576 local1.info] INFO RADOP(13) acct start for 5556374832@splunktel.com " + internalclientipAddress + " from " + externalclientipAddress + " recorded OK." + "\n"
	webline = datetime.datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S') + ":" + str(randMs1) + " " + webHost + " " + uri + " - 80 - " + internalclientipAddress + " \"Mozilla/5.0 (iPhone; CPU iPhone OS 5_0_1 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9A405 Safari/7534.48.3\"" + " 503 0 0 " + timeTaken + " " + bytesXferred + "\n"
	radstopline = datetime.datetime.utcnow().strftime('%b %d %H:%M:%S') + ":" + str(randMs2) + " " + radHost + " " + "radiusd[" + radPID + "]:" + "[ID 959576 local1.info] INFO RADOP(13) acct stop for 5556374832@splunktel.com " + internalclientipAddress + " from " + externalclientipAddress + " recorded OK." + "\n"
