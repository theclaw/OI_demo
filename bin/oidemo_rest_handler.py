...
def setup_logger():
    ...
    logger = logging.getLogger('oidemo_rest_handler')
...
class OIDemoConfigApp(admin.MConfigHandler):
    '''
    ...
    def handleEdit(self, confInfo):
        ...
        if int(self.callerArgs.data['installeventgen'][0]) == 1:
            ...
            filename = pathParser('$SPLUNK_HOME/etc/apps/oidemo/SA-Eventgen.spl')
...
admin.init(OIDemoConfigApp, admin.CONTEXT_NONE)